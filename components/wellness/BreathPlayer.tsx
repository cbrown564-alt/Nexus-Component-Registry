  ...
  return (
    <WellnessCard className="flex flex-col items-center justify-center text-center h-full">
      ...
      <div className="relative mt-12 mb-12 flex h-48 w-48 items-center justify-center">
        ...
        {/* Main Circle */}
        <div
          className="relative z-10 flex h-32 w-32 items-center justify-center rounded-full shadow-lg ring-1 transition-colors"
          style={{
            background: `linear-gradient(to bottom right, ${theme.colors.card}, ${theme.colors.muted})`,
