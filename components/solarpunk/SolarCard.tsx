...
const SolarCard: React.FC<SolarCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden backdrop-blur-xl border border-emerald-100 shadow-[0_8px_32px_rgba(16,185,129,0.1)] rounded-[2rem] rounded-tr-[4rem] rounded-bl-[3rem] ${className}`}
