  ...
  return (
    <FintechCard className="p-0">
      ...
      <div style={{ borderColor }}>
        {assets.map((asset, i) => (
          <div key={i} className="group flex items-center justify-between p-4 transition-colors hover:bg-white/5 border-b last:border-0" style={{ borderColor: `${borderColor}33` }}>
