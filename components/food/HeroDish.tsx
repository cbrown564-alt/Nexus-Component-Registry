    ...
    <FoodCard className="group relative h-[400px] w-full border-none cursor-pointer">
       ...
       <div className="absolute bottom-0 left-0 w-full p-8">
           ...
           <div className="flex items-center justify-between">
               ...
               <button className="flex items-center gap-2 rounded-full bg-white px-6 py-3 font-bold text-stone-900 transition-transform hover:scale-105 hover:bg-orange-50 active:scale-95">
