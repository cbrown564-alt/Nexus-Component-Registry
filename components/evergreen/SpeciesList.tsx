...
import { Bug, Bird, Rat } from 'lucide-react'; // Using approximate icons
    ...
    return (
        <OrganicContainer variant="glass" className="h-full flex flex-col">
            ...
            <div className="mt-4 pt-4 border-t border-[#78866b]/10 text-center">
                <span className="text-xs text-[#78866b] font-bold uppercase tracking-widest cursor-pointer hover:underline">View All 42 Species</span>
            </div>
        </OrganicContainer>
    );
};
