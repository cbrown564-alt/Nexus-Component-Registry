...
const LegacyButton: React.FC<LegacyButtonProps> = ({ 
  ...
  return (
    <button
      className={`px-4 py-1 font-mono text-lg text-black bg-[#c0c0c0] outline-none active:translate-y-[1px] active:shadow-[inset_1px_1px_#000000,inset_-1px_-1px_#ffffff] ${
        active 
