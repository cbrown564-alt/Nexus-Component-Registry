...
const LaneAssist = () => {
    return (
        <CockpitCard className="h-full p-0 overflow-hidden relative group" noPadding>
            ...
            {/* Other Car (Simulated) */}
            <div className="absolute top-[45%] left-[65%] bg-zinc-800 w-12 h-8 rounded-lg shadow-lg opacity-50 blur-[1px]" />
