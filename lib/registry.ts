...
export const templates: Template[] = [
    ...
    },
    {
        ...
        visualLanguageId: 'professional',
        colorClass: 'bg-[#cda45e]',
        backgroundColor: 'bg-[#09090b]',
        textColorClass: 'text-[#f4f4f5]',
        sidebarStyles: 'border-[#cda45e]/20 bg-[#09090b]',
        mobileTier: 'poor',
        category: 'dark',
        tags: ['hospitality', 'luxury', 'hotel', 'dark'],
    },
    {
        id: 'paradox',
        name: 'Paradox',
        ...
        sidebarStyles: 'border-black border-r-[4px] bg-[#e5e5e5]',
        mobileTier: 'passable',
        category: 'colorful',
        tags: ['glitch', 'brutalist', 'chaos', 'art'],
    },
    {
        id: 'terminal',
        name: 'Console',
        ...
        visualLanguageId: 'professional',
        colorClass: 'bg-[#61afef]',
        backgroundColor: 'bg-[#0c0c0c]',
        textColorClass: 'text-[#abb2bf]',
        sidebarStyles: 'border-[#3e4451] bg-[#0c0c0c]',
        mobileTier: 'poor',
        category: 'dark',
        tags: ['dev', 'cli', 'tui', 'dark'],
    },
    {
        id: 'flux',
        name: 'Flux',
        description: 'High-velocity social feed with haptic scroll.',
        visualLanguageId: 'consumer',
        ...
        mobileTier: 'first',
        category: 'dark',
        tags: ['social', 'feed', 'mobile-first', 'haptics'],
    },
    {
        id: 'neo',
        name: 'Neo',
        description: 'Premium finance wallet with gyro-parallax cards.',
        visualLanguageId: 'professional',
        colorClass: 'bg-emerald-500',
        backgroundColor: 'bg-[#0a0a0a]',
        textColorClass: 'text-emerald-50',
        sidebarStyles: 'border-emerald-900/20 bg-[#0a0a0a]',
        mobileTier: 'first',
        category: 'dark',
        tags: ['finance', 'wallet', 'mobile-first', 'gyro'],
    },
    {
        id: 'zen',
        name: 'Zen',
        description: 'Distraction-free reader with thumb-zone controls.',
        visualLanguageId: 'organic',
        colorClass: 'bg-stone-500',
        backgroundColor: 'bg-[#f5f5f4]',
        textColorClass: 'text-stone-900',
        sidebarStyles: 'border-stone-200 bg-[#f5f5f4]',
        mobileTier: 'first',
        category: 'light',
        tags: ['reader', 'minimal', 'mobile-first', 'thumb-zone'],
    },
    {
        id: 'touch',
        name: 'Touch',
        description: 'IoT controller with neumorphic tactile inputs.',
        visualLanguageId: 'organic',
        colorClass: 'bg-sky-500',
        backgroundColor: 'bg-[#e0e5ec]',
        textColorClass: 'text-slate-700',
        sidebarStyles: 'border-slate-300 bg-[#e0e5ec]',
        mobileTier: 'first',
        category: 'light',
        tags: ['iot', 'remote', 'mobile-first', 'neumorphic'],
    },
    {
        id: 'signal',
        name: 'Signal',
        description: 'Chat interface with organic breathing animations.',
        visualLanguageId: 'consumer',
        colorClass: 'bg-pink-500',
        backgroundColor: 'bg-[#fff0f5]',
        textColorClass: 'text-pink-900',
        sidebarStyles: 'border-pink-200 bg-white',
        mobileTier: 'first',
        category: 'colorful',
