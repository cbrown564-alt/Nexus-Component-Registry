...
const LegacyOSDashboard = () => {
  ...
  return (
    <div className="h-screen w-full bg-[#008080] font-mono text-black overflow-hidden relative selection:bg-[#000080] selection:text-white">
      ...
      <div className="absolute inset-0 p-12 pointer-events-none grid grid-cols-1 md:grid-cols-2 gap-8 items-start pt-20">
        ...
        <div className="pointer-events-auto transform hover:z-10 hover:scale-[1.01] transition-transform">
            <LegacyWindow title="C:\WINDOWS\SYSTEM32" isActive={activeWindow === 'explorer'}>
                <div className="bg-white border-[2px] border-inset border-[#808080] h-64 p-2 overflow-y-auto">
                ...
                <div className="p-1 text-xs border-t border-[#c0c0c0] flex gap-2">
      ...
      {/* Taskbar */}
      <div className="absolute bottom-0 left-0 right-0 h-10 bg-[#c0c0c0] border-t-2 border-white flex items-center justify-between px-1 z-50 shadow-[0_-1px_0_#000]">
          <div className="flex items-center gap-2 h-full py-1">
              ...
              {startOpen && (
                  <div className="absolute bottom-10 left-1 w-48 bg-[#c0c0c0] border-2 border-white border-r-black border-b-black shadow-xl p-1 flex flex-col gap-1">
              ...
              <div className="w-[2px] h-full bg-[#808080] border-r border-white mx-1" />
              
              {/* Taskbar Items */}
              <div className="flex gap-1">
                  <div className="w-36 h-full bg-[#c0c0c0] shadow-[inset_1px_1px_#ffffff,inset_-1px_-1px_#000000] active:bg-[#e0e0e0] active:shadow-[inset_1px_1px_#000000,inset_-1px_-1px_#ffffff] flex items-center px-2 gap-2 cursor-pointer border border-black border-t-white border-l-white bg-[url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAYAAACp8Z5+AAAAIklEQVQIW2NkQAKrVq36zwjjgzjwqJAwAxQBNgFUAxQBDgAAP+gK/mAA9F0AAAAASUVORK5CYII=')]">
                      <Folder className="h-4 w-4" />
                      <span className="text-xs truncate font-bold">C:\WINDOWS</span>
                  </div>
                  <div className="w-36 h-full bg-[#c0c0c0] shadow-[inset_1px_1px_#ffffff,inset_-1px_-1px_#000000] flex items-center px-2 gap-2 cursor-pointer border border-black border-t-white border-l-white">
          ...
          {/* System Tray */}
          <div className="h-full py-1 pr-1 pl-2 border-2 border-[#808080] border-r-white border-b-white bg-[#c0c0c0] shadow-[inset_1px_1px_#000000] flex items-center gap-3 px-2">
