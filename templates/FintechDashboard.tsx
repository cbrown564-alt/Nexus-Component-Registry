...
import { Wallet, PieChart, ArrowRightLeft, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto max-w-[1600px] min-h-screen p-6 lg:p-10 font-sans text-zinc-200">
      ...
      <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          ...
          >
              <button className="flex items-center gap-2 rounded-lg bg-zinc-800 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-700 transition-colors">
                  <ArrowRightLeft className="h-4 w-4" />
                  Transfer
              </button>
              <button className="flex items-center gap-2 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-500 transition-colors shadow-lg shadow-emerald-500/20">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
              ...
              <FintechCard className="p-6">
                  ...
                  <button className="w-full bg-zinc-100 text-zinc-950 font-bold py-3 rounded-lg hover:bg-white transition-colors">
                      Send Money
                  </button>
              </FintechCard>
          </div>
