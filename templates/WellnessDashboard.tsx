    ...
    <div className="container mx-auto max-w-6xl p-8 font-sans text-stone-800">
      ...
      <section className="mb-16 mt-8 flex flex-col md:flex-row items-end justify-between gap-8">
        ...
        <motion.div 
           ...
           className="flex items-center gap-2 text-sm font-medium text-stone-900 border-b border-stone-900 pb-1 cursor-pointer hover:text-stone-600 hover:border-stone-600 transition-colors"
        >
      ...
      <section className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 auto-rows-min">
        ...
        <WellnessCard delay={0.2} className="flex flex-col justify-between">
           ...
           <button className="mt-4 w-full rounded-xl bg-stone-100 py-3 text-sm font-medium text-stone-600 transition-colors hover:bg-blue-50 hover:text-blue-600">
             + Add Water
           </button>
        </WellnessCard>
