            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <EducationCard featured className="p-8 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-wrap gap-4">
                                <EducationButton variant="secondary" size="lg" icon={<Play className="h-4 w-4" />} className="bg-white text-violet-600 hover:bg-violet-50">
                                    Start Learning
                                </EducationButton>
                                <EducationButton variant="outline" size="lg" icon={<BookOpen className="h-4 w-4" />} className="border-white/30 text-white hover:bg-white/10">
                                    View Syllabus
                                </EducationButton>
                            </div>
                        </div>
                ...
                <div className="space-y-8">
                    ...
                    <EducationCard className="p-6">
                        ...
                        <EducationButton variant="ghost" size="md" icon={<Plus className="h-4 w-4" />} className="w-full border border-dashed border-slate-300 text-slate-500 hover:border-violet-300 hover:text-violet-600">
                            Add New Task
                        </EducationButton>
                    </EducationCard>
                </div>
