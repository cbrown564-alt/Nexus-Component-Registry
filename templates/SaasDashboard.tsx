    ...
    return (
        ...
        >
            ...
            <section className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                >
                    <div className="flex items-center rounded-md p-1" style={{ borderWidth: '1px', borderColor: 'rgba(30, 41, 59, 0.2)', backgroundColor: '#0f172a' }}>
                    ...
                    <div className="h-8 w-px mx-1" style={{ backgroundColor: 'rgba(30, 41, 59, 0.2)' }} />
