          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
              ...
              <GridCard title="Network Topology" className="flex-1 min-h-[200px]">
                  <div className="flex flex-col gap-4 text-xs font-mono text-blue-200">
                      ...
                      <div className="relative h-40 w-full border border-blue-900/30 bg-slate-900 rounded p-2 flex items-center justify-center">
                          <span className="text-slate-600">Topology Visualization</span>
                          {/* Animated Lines */}
                          <div className="absolute inset-0 overflow-hidden opacity-20">
                              <svg width="100%" height="100%">
                                  ...
                                  <circle cx="50%" cy="50%" r="20%" stroke="#3b82f6" fill="none" />
                              </svg>
                          </div>
                      </div>
                  </div>
