...
const AcidDashboard = () => {
    ...
    return (
        <div
            className="min-h-screen font-sans p-4 md:p-8 overflow-hidden relative selection:text-black"
            style={{
        ...
        >
            ...
            {/* Background Marquee */}
            <div className="fixed left-0 top-0 h-full w-12 border-r-4 bg-white z-0 hidden lg:block" style={{ borderColor: theme.colors.border }}>
            ...
            <div className="relative z-10 max-w-5xl mx-auto lg:pl-12 lg:pr-12">
                ...
                <header className="mb-12 flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
                    <div className="relative">
                        <Sticker className="-top-6 -right-6 rotate-12 text-white" style={{ backgroundColor: theme.colors.secondary }}>v3.0</Sticker>
                        <h1 className="text-7xl md:text-9xl font-black italic tracking-tighter leading-[0.8] text-black mix-blend-hard-light" style={{ color: theme.colors.foreground }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="relative">
                        ...
                        <AcidCard rotate={-2} className="p-0 h-full">
                            ...
                            <div className="p-6 text-center -mt-16">
                                ...
                                <p className="font-mono text-xs mb-4 text-white inline-block px-2" style={{ backgroundColor: theme.colors.foreground }}>Lvl. 99 Troll</p>
                    ...
                    <div className="relative h-64 md:h-auto">
                        <AcidCard color={`bg-[${theme.colors.secondary}]`} rotate={3} className="h-full flex items-center justify-center p-8 text-center text-white" style={{ backgroundColor: theme.colors.secondary } as any}>
